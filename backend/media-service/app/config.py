...
class Config:
    ...
    AZURE_BLOB_CONTAINER_URL = os.environ.get("AZURE_BLOB_CONTAINER_URL", "https://skillscreenstorage00.blob.core.windows.net/video-recordings?sp=racwdl&st=2025-11-18T22:02:53Z&se=2026-01-01T06:17:53Z&spr=https&sv=2024-11-04&sr=c&sig=7nA14qtnnJ6wGV9Mu5RQJDPBfLANTdFu2rcgD1QikBI%3D")
    AZURE_BLOB_ACCOUNT_URL = os.environ.get("AZURE_BLOB_ACCOUNT_URL", "https://skillscreenstorage00.blob.core.windows.net")
