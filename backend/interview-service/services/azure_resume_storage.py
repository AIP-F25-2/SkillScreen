...
class AzureResumeStorage:
    ...
    def __init__(self):
        ...
        sas_url = os.getenv(
            ...
            "https://skillscreenstorage00.blob.core.windows.net/resumes?sp=racwdl&st=2025-11-27T04:10:47Z&se=2026-01-01T12:25:47Z&spr=https&sv=2024-11-04&sr=c&sig=13f8k4JW31E4kbzg52s%2BWhAuZE32AAhvjpo1eLjG%2BdA%3D"
        )
