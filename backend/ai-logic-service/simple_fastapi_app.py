...
async def parse_resume(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Parse the resume using the resume_parser
        parsed_data = resume_parser.parse_resume_from_pdf(pdf_file)
...
if __name__ == "__main__":
    ...
    print("Starting SkillScreen AI Logic Service...")
    print(f"API will be available at: http://{host}:{port}")
    print(f"API documentation at: http://{host}:{port}/docs")
    print(f"Interactive API testing at: http://{host}:{port}/redoc")
